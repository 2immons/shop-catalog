...
import SearchButton__Mobile from "@/components/mobile_header/SearchButton__Mobile.vue";

export default defineComponent({
  name: "SearchInput__Mobile",
  components: { SearchButton__Mobile },
  data () {
    return {
      searchText: ''
    }
